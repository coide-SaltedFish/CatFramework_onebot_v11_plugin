...
import org.catcat.sereinfish.qqbot.universal.abstraction.layer.events.notice.GroupAdminSetEvent
...
class OneBotGroupAdminSetEvent(
...
): GroupAdminSetEvent, OneBotGroupNoticeEvent() {
    ...
    internal companion object: EventParser {
        ...
        override fun match(data: JsonElement): Boolean {
            ...
            return obj["notice_type"].asString == "group_admin" && obj["sub_type"].asString == "set"
        }
        ...
        override fun parser(data: JsonElement): OneBotEvent {
            ...
            return OneBotGroupAdminSetEvent(
                bot = bot,
                time = time,
                user = user,
                group = group
